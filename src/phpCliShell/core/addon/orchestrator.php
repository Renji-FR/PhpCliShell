<?php
	...
	use PhpCliShell\Core\Addon\Orchestrator\Selector;
	use PhpCliShell\Core\Addon\Orchestrator\InterfaceOrchestrator;

	abstract class Orchestrator implements InterfaceOrchestrator, \Iterator, \ArrayAccess, \Countable
	{
		/**
		  * @var string
		  */
		...
		/**
		  * @var \PhpCliShell\Core\Addon\Orchestrator\Selector\Service
		  */
		...
		/**
		  * @return null|\PhpCliShell\Core\Config
		  */
		...
		/**
		  * @param \PhpCliShell\Core\Addon\Service[] $ids
		  * @return bool
		  */
		...
		/**
		  * @param string $id
		  * @return false|\PhpCliShell\Core\Addon\Service
		  */
		...
		/**
		  * @param \PhpCliShell\Core\Addon\Orchestrator\Selector\Service $selector
		  * @return $this
		  */
		public function setServiceSelector(Selector\Service $selector)
		{
