<?php
	...
	// If does not exists, no error/warning throw
	use PhpCliShell\Core\ArrayObject as MyArrayObject;
	...
	class Tools
	{
		...
		public static function arrayToObject($input = array(), $MyArrayObject = true)
		{
			...
			{
				/**
				  * class_exists does not work with class alias defined with use
				  */
				if(class_exists(__NAMESPACE__ .'\ArrayObject') && $MyArrayObject) {
