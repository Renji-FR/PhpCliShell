<?php
	namespace PhpCliShell\Addon\Dcim\Connector;
	...
	use PhpCliShell\Addon\Dcim\Service;
	use PhpCliShell\Addon\Dcim\Exception;

	class Soap extends AbstractConnector
	{
		const METHOD = 'SOAP';
		...
		/**
		  * @param \PhpCliShell\Addon\Dcim\Service $service
