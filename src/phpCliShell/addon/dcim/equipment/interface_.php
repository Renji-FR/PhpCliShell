<?php
	...
	abstract class Interface_ extends Interface_\Logical
	{
		...
		/**
		  ...
		  * @param string|\PhpCliShell\Addon\Dcim\Equipment\Port $port
		...
		{
			return ($this->_mode === static::INT_LOGICAL);
		}
		...
		/**
		  * @param \PhpCliShell\Addon\Dcim\Equipment\Interface_ $neighborInterface
		  * @return array
		  */
		protected function _getNeighborDatas(Interface_ $neighborInterface)
		{
			$datas = array();
