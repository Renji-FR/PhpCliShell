<?php
	...
	abstract class Slot extends Interface_\Physical
	{	
		/**
		  * @var int
		  */
		...
		/**
		  * @var \PhpCliShell\Addon\Dcim\Api\EquipmentSlot
		  */
		...
		public function __construct(Equipment $equipment, $slotId)
		{
			...
			$this->_slotApi = new Api\EquipmentSlot($this->_slotId);
		}
		...
		public function getEquipmentId($connectorId = null)
		{
			if($connectorId === null || (int) $connectorId === $this->getSlotId()) {
				...
				$Api_Equipment_Slot = new Api\EquipmentSlot($connectorId);
