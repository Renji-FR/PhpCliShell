<?php
	...
	use PhpCliShell\Addon\Dcim\Equipment\Interface_;

	abstract class Port extends Interface_\Physical
	{
		/**
		  * @var int
		  */
		...
		/**
		  * @var \PhpCliShell\Addon\Dcim\Api\EquipmentPort
		  */
		...
		public function __construct(Equipment $equipment, $portId)
		{
			...
			$this->_portApi = new Api\EquipmentPort($this->_portId);
		}
		...
		public function setInterface(Interface_ $interface)
		{
		...
		public function getEquipmentId($connectorId = null)
		{
			if($connectorId === null || (int) $connectorId === $this->getPortId()) {
				...
				$Api_Equipment_Port = new Api\EquipmentPort($connectorId);
		...
		public function getNeighborPortId($portId = null)
		{
			if($portId === null || (int) $portId === $this->getPortId())
			{
				...
				$Api_Equipment_Port = new Api\EquipmentPort($portId);
			}
		...
		public function setNeighborPort(Port $portEquipment)
		{
			if(!$this->hasNeighborPort()) {
