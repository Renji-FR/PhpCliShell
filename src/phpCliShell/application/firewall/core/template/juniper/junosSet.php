<?php
	...
	class JunosSet extends Junos
	{
		...
		protected function _getTemplateVars()
		{
			...
			if(isset($this->_CONFIG->configuration->templates->{self::VENDOR.'-'.self::PLATFORM.'_'.self::TEMPLATE}->updateMode))
			{
				$updateMode = $this->_CONFIG->configuration->templates->{self::VENDOR.'-'.self::PLATFORM.'_'.self::TEMPLATE}->updateMode;
