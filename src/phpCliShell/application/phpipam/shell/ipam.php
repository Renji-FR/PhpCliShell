<?php
	namespace PhpCliShell\Application\Phpipam\Shell;
	...
	use PhpCliShell\Application\Phpipam\Shell\Program;

	class Ipam extends Cli\Shell\Browser
	{
		const SHELL_HISTORY_FILENAME = '.ipam_phpipam.history';
		...
		/**
		  * @var \PhpCliShell\Addon\Ipam\Phpipam\Service
		  */
		...
		{
			return $this->_CONFIG->IPAM_PHPIPAM;
		}
