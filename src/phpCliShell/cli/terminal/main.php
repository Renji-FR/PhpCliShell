<?php
	...
	abstract class Main
	{
						...
						foreach($inputs as $index => $input)
						{
							...
							if($index < $counterEOL)
							{
								...
								if($result !== null)
								{
									...
									/**
									  * STDIN peut être lu à partir d'ici, exemple: Symfony Question
									  * Il faut donc rétablir le stream STDIN dans son état initial
									  * C'est pour cela que _cleaner et _quit sont appelés avant !									  
									  */
		...
		protected function _quit()
		{
			...
			/**
			  * On rétablit le mode par défaut qui est bloquant
			  * Pour Symfony, QuestionHelper requière le mode bloquant
			  */
