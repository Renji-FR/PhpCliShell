<?php
	...
	class Commands extends AbstractAutocompletion implements \Countable
	{
		/**
		  * @var array
		  */
		...
		public function __construct(array $defCommands, Arguments $shAcArguments = null)
		{
		...
		public function declareArguments(Arguments $shAcArguments)
		{
