<?php
	...
	use PhpCliShell\Cli\Terminal\Autocompletion;

	class Autocompletion
	{
		/**
		  * @var \PhpCliShell\Cli\Terminal\Autocompletion\Commands
		  */
		protected $_cliAcCommands = null;

		/**
		  * @var \PhpCliShell\Cli\Terminal\Autocompletion\Arguments
		  */
		...
		{
			$this->_cliAcCommands = new Autocompletion\Commands($defCommands);
			$this->_cliAcArguments = new Autocompletion\Arguments($defInlineArgs, $defOutlineArgs);
