<?php
	...
	abstract class Program extends Main
	{
		...
		/**
		  * @return \PhpCliShell\Cli\Terminal\Main
		  */
		...
		/**
		  * @return \PhpCliShell\Cli\Shell\Main
		  */
		...
		/**
		  * @return \PhpCliShell\Cli\Results
		  */
		...
		/**
		  * @param string $name Program class or key
		  * @return false|mixed Return the program or false if it does not exist
		  */
		public function getProgram($name)
		{
			if(array_key_exists($name, $this->_programs)) {
		...
		/**
		  * @return array Return all programs
		  */
		...
		public function __get($name)
		{
			switch($name)
			{
				...
				/*case 'program': {
					return new ArrayObject($this->_programs, ArrayObject::ARRAY_AS_PROPS);
				}*/
				default: {
